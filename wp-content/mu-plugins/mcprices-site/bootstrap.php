<?php
/**
 * Site-specific McPrices hooks and helpers.
 *
 * Loaded by the must-use integration after the Kadence parent theme is ready.
 */
...
function kadence_mcprices_get_default_social_image_url() {
	...
	return esc_url_raw( mcprices_site_url( 'assets/images/mcprices/official/items/big-mac.jpg' ) );
}
...
function kadence_mcprices_get_default_favicon_url() {
	return esc_url_raw( mcprices_site_url( 'assets/images/mcprices/mcprices-logo-schema.svg' ) );
}
